...
const PatternEvents: FC = () => {
  const { events, color } = useAppSelector(
  ...
  const OnClickAdd = () => {
    if (!!timeActVal && !!actVal) {
      ...
      dispatch(addEventsPattern(newEvent));
    }
  };
  ...
  return (
    <section className=" flex flex-col justify-between">
      <section>
        <h1 className=" text-center font-bold my-2">Add Events</h1>
      ...
      >
        ...
        <div className=" flex">
          <Button
            variant="destructive"
            onClick={() => dispatch(deleteEventsPattern(idVal))}
